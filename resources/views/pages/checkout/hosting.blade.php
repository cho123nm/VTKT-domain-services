                        ...
                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                            <div class="py-10">
                                <h1 class="anchor fw-bold mb-5" id="text-input" data-kt-scroll-offset="50">
                                    <a href="#text-input"></a> Mua Hosting
                                </h1>
                                <div class="py-5">
                                    <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            <label class="required fw-semibold fs-6 mb-2"> Tên Gói Hosting </label>
                                            <input type="text" id="name" class="form-control form-control-solid mb-3 mb-lg-0" value="{{ htmlspecialchars($hosting->name) }}" disabled>
                                        </div>
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            <label class="fw-semibold fs-6 mb-2"> Mô Tả </label>
                                            <textarea class="form-control form-control-solid mb-3 mb-lg-0" disabled>{{ htmlspecialchars($hosting->description ?? '') }}</textarea>
                                        </div>
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <div class="fv-row mb-10">
                                            <div class="alert alert-info">
                                                <strong>Lưu ý:</strong> Sau khi thanh toán, bạn sẽ được chuyển đến trang liên hệ admin để nhận thông tin hosting.
                                            </div>
                                        </div>
...
<input type="hidden" id="checkout-url" value="{{ route('checkout.hosting.process') }}">
...
$(document).ready(function() {
    ...
    $('#buy').on('click', function() {
        ...
        var period = $('#period').val();
        var checkoutUrl = $('#checkout-url').val();
