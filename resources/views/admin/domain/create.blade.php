        ...
        <div class="preview">
            ...
            <form action="{{ route('admin.domain.store') }}" method="post">
                ...
                <div class="form-inline">
                    ...
                    <input id="horizontal-form-1" type="text" name="duoi" class="form-control" placeholder="Đuôi Miền (ví dụ: .com)" required>
                </div>
                ...
                <div class="form-inline mt-5">
                    ...
                    <input id="horizontal-form-1" type="number" class="form-control" name="price" placeholder="Giá Bán" required>
                </div>
