...
@section('title', 'Danh Sách Source Code')

@section('content')
<div class="col-span-12 mt-6">
    <div class="intro-y block sm:flex items-center h-10">
        <h2 class="text-lg font-medium truncate mr-5">Danh Sách Source Code</h2>
        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
            <a href="{{ route('admin.source-code.create') }}" class="btn btn-primary">Thêm Source Code</a>
        </div>
    </div>
        ...
        <table class="table table-report sm:mt-2">
            ...
            <tbody>
                @if($sourceCodes->isEmpty())
                    <tr>
                        <td colspan="4" class="text-center">Chưa có source code nào</td>
                    </tr>
                @else
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{ route('admin.source-code.edit', $item->id) }}">
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    ...
                    <form action="{{ route('admin.source-code.destroy', $item->id) }}" method="post">
                        @csrf
                        @method('DELETE')
