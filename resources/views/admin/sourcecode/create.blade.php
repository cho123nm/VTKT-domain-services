...
<div class="intro-y box mt-5">
    ...
    <div id="horizontal-form" class="p-5">
        <div class="preview">
            ...
            <form action="{{ route('admin.sourcecode.store') }}" method="POST" enctype="multipart/form-data"> 
                @csrf
                <div class="form-inline">
                    <label for="name" class="form-label sm:w-20"> Tên Source Code </label>
                    <input id="name" type="text" name="name" class="form-control" placeholder="Tên source code" value="{{ old('name') }}" required>
                </div>
                <div class="form-inline mt-5">
                    <label for="description" class="form-label sm:w-20"> Mô Tả </label>
                    <textarea id="description" name="description" class="form-control" placeholder="Mô tả source code">{{ old('description') }}</textarea>
                </div>
                <div class="form-inline mt-5">
                    <label for="category" class="form-label sm:w-20"> Loại </label>
                    <input id="category" type="text" name="category" class="form-control" placeholder="PHP, Laravel, etc." value="{{ old('category') }}">
                </div>
                <div class="form-inline mt-5">
                    <label for="price" class="form-label sm:w-20"> Giá Tiền </label>
                    <input id="price" type="number" class="form-control" name="price" placeholder="Giá Bán" value="{{ old('price') }}" required>
                </div>
                <div class="form-inline mt-5">
                ...
                <div class="form-inline mt-5">
                    ...
                    <input id="download_link" type="text" name="download_link" class="form-control" placeholder="https://..." value="{{ old('download_link') }}">
                </div>
