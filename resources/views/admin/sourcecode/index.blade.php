...
<div class="col-span-12 mt-6">
    <div class="intro-y block sm:flex items-center h-10">
        ...
        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
            <a href="{{ route('admin.sourcecode.create') }}" class="btn btn-primary"> Thêm Source Code </a>
        </div>
    </div>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{ route('admin.sourcecode.edit', $item->id) }}">
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    ...
                    <form action="{{ route('admin.sourcecode.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
