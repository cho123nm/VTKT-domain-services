    ...
    if ($msg == "true") {
        ...
        if(!is_array($result) || !isset($result['error']))
        {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $GLOBALS['output'] .= "<td><a title='".__('edit')."' class='btn btn-success btn-circle' href='edit.php?id=" . $row['serial'] ."&wtd=edit'"."><i class='fa fa-pencil'></i></a>&nbsp&nbsp<a title='".__('delete')."' class='btn btn-danger btn-circle' href='edit.php?id=" . $row['serial'] ."&wtd=delete'"."><i class='fa fa-trash-o'></i></a></td>";
                $GLOBALS['output'] .= "</tr>";
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            <i class="fa fa-money"></i> <?php echo __('cost_view');?>
        </h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-list"></i> <?php echo __('hostel_cost_list_view');?>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="apyment" action="view.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                <button type="submit" class="btn btn-info pull-right"  name="btnPrint" ><i class="fa fa-print"></i><?php echo __('print');?></button>
                            </form>
                        </div>
                    </div>
                    <div class="row">
