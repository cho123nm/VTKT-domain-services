...
else
{
    ...
    //load student list (UG004 chỉ được chọn chính mình)
    $data = array();
    $GLOBALS['output'] = '';
    if($loginGrp==="UG004"){
        $name=$ses->Get("name");
    ...
    if(isset($_POST["btnSave"])) {
        ...
        if ($msg == "true") {
         ...
         //   $handyCam = new \handyCam\handyCam();
            //var_dump($billId);
            // UG004 chỉ được tạo bill cho chính mình
            $userId = ($loginGrp === "UG004") ? $loginId : $_POST['person'];
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            <i class="fa fa-file-text"></i> <?php echo __('bill_add');?>
        </h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-info-circle"></i> Thông tin hóa đơn
            </div>
