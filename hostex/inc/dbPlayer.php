...
class dbPlayer {
   ...
   public function open(){
    ...
    public  function  getData($query)
    {
        ...
        if(!$res)
        {
            // Return an array with error flag instead of string
            return array('error' => true, 'message' => "Can't get data ".mysqli_error($this->con));
        }
        else
        {
            return $res;
    ...
    public  function execDataTable($query)
    {
        ...
        if(!$res)
        {
            return array('error' => true, 'message' => "Can't Execute Query".mysqli_error($this->con));
        }
        else
        {
            return $res;
